...
class TestPlannedOperationArchived:
    """Tests for the is_archived field on PlannedOperation."""

    def test_default_not_archived(self) -> None:
        """Test that planned operations are not archived by default."""
        op = PlannedOperation(
            record_id=1,
            description="Test",
            amount=Amount(100.0),
        ...
        assert op.is_archived is False

    def test_create_archived(self) -> None:
        """Test creating an archived planned operation."""
        op = PlannedOperation(
            record_id=1,
            description="Test",
            amount=Amount(100.0),
    ...
    def test_replace_with_is_archived(self) -> None:
        ...
        archived = op.replace(is_archived=True)
    ...
    def test_replace_preserves_is_archived(self) -> None:
        ...
        replaced = op.replace(description="Updated")
